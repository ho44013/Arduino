...
#define INTERVAL 20.0  // servo update interval
...
// convert angle speed into duty change per interval.
  duty_chg_per_interval = (double) (_DUTY_MAX - _DUTY_MIN) * (_SERVO_SPEED / 180.0) * (INTERVAL / 1000.0);
...
// initialize variables for servo update.
  pause_time = 1;
  toggle_interval = (180.0 / _SERVO_SPEED + pause_time) * 1000.0 / INTERVAL;
